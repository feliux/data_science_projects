---
title: "Análisis exploratorio con R"
...
En este informe trataremos de ilustrar posibilidades de R para análisis exploratorio de datos sobre el dataset Student.zip:
...
library(knitr)
# Para generar un doc bien formateado desde nuestro script Rmarkdown
...
Primero utilizaremos diferentes variedades de histogramas.

```{r analisis_vars_hist, echo=TRUE, results='hold', message=FALSE, warning=FALSE, error=FALSE, fig.width=5, fig.height=5}

hist(studentMat$absences, main = "Fig 1.1: Histograma ausencias matemáticas", cex.main=0.7)

library(ggplot2)

#plot.new()
qplot(studentMat$absences, binwidth = 5, main = "Fig 1.2: Histograma ausencias matemáticas")

#plot.new()
ggplot(studentMat, aes(x=absences)) + 
        geom_histogram(binwidth = 20, fill = "white", colour = "black", origin = 0) +
        ggtitle ("Fig 1.1 Histograma ausencias matemáticas") +
...
```{r analisis_vars_bar, echo=TRUE, results='hold', message=FALSE, warning=FALSE, error=FALSE, fig.width=5, fig.height=5}
...
```{r analisis_vars_target, echo = TRUE, results='hold', warning=FALSE, error=FALSE, fig.width=5, fig.height=5}
...
```{r box_plots, echo=TRUE, results='hold', message=FALSE, warning=FALSE, error=FALSE, fig.width=5, fig.height=5}
...
La matriz de correlación puede usarse en la fase de modelado para seleccionar las variables que queremos incluir en el modelo. A veces, si hay 2 muy correlacionadas, se decide incluir sólo una de ellas.

### Conclusiones finales

Sería conveniente una clasificación más detallada de las profesiones de las madres de los alumnos ya que puede guardar alguna relación con la nota final, seguramente en combinación con otras variables, pero hay muchas instancias de "Other".
